...
public class B extends A {
    public void methodB() {
        ...
        /*
         * We are capable of accessing their attributes directly as we can view
         * a parent class's attributes with default, public and protected access modifiers
         */
    }
    ...
    /*
     * Here, we cannot restrict the visibility of the overridden method
     * Since default is more restricted than protected, then we have a compiler
     * error is we uncomment the latter
     */
}
