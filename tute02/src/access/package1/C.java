...
public class C {
    public void methodC() {
        ...
        /*
         * Protected and default don't have much reason for being used
         * You could get through the course only using 
         * public and private with no issues, but it is good to understand how
         * to read them if examined
         */
    }
}
